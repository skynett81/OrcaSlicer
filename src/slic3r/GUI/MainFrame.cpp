...
static wxMenu* generate_help_menu()
{
    ...
    // Report a bug
    //append_menu_item(helpMenu, wxID_ANY, _L("Report Bug(TODO)"), _L("Report a bug of 3DPrintForge Slicer"),
    //    [](wxCommandEvent&) {
    //        //TODO
    //    });
    // Check New Version
...
//    });
    ...
    append_menu_item(forge_menu_linux, wxID_ANY, _L("Forge Library..."),
        ...
        [this]() { return true; }, this);
    append_menu_item(forge_menu_linux, wxID_ANY, _L("Colour Layer Generator..."),
    ...
    append_menu_item(calib_menu, wxID_ANY, _L("Calibration Guide"), _L("Calibration Guide"),
        [this](wxCommandEvent&) { wxLaunchDefaultBrowser("https://skynett81.github.io/3dprintforge/docs/calibration/calibration_guide", wxBROWSER_NEW_WINDOW); }, "", nullptr,
        [this]() {return m_plater->is_view3D_shown();; }, this);
    ...
    append_menu_item(forge_menu, wxID_ANY, _L("Forge Library..."),
        ...
        [this]() { return true; }, this);
    append_menu_item(forge_menu, wxID_ANY, _L("Colour Layer Generator..."),
        _L("Turn an image into a multi-colour relief (HueForge-style)"),
        [this](wxCommandEvent&) {
            Slic3r::GUI::ForgeColorLayerDialog dlg(this);
            dlg.ShowModal();
