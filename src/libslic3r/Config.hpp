...
// When parsing a configuration value, if the old_value is not understood by this 3DPrintForge Slicer version,
// it is being substituted with some default value that this 3DPrintForge Slicer could work with.
