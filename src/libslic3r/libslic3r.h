...
#define SLIC3R_APP_FULL_NAME "3DPrintForge Slicer"
#define GCODEVIEWER_APP_NAME "3DPrintForge Slicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "3DPrintForgeSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("3DPrintForge Slicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
